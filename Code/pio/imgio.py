...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 11 16:51:32 2020
...
class imgio: 
    ...
    def __repr__(self):
        ...
        return 'imgio("%s",ix=%d,iy=%d,it=%d,min=%.0f,' \
            'max=%.0f,unsigned=%d,bytes=%d,channels=%d)' % (self.file_name,self.ix,self.iy,self.it,self.min,
                                                            self.max,self.unsigned,self.bytes,self.channels)
