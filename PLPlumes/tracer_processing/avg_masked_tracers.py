...
def mask_tracer_piv(params):
    img,piv,threshold,window_threshold,masks,slices = params
    step = (piv.dx,piv.dy)
    masks = []
    u = []
    v = []
...
def main():
    ...
    avg_mask, u_m_avg,v_m_avg = average_masked_vel(img,piv,frame,threshold,window_threshold,masks,slices)
